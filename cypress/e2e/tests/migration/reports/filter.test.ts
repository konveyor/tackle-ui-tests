...
describe.skip(["@tier2"], "Bug MTA-1762: Reports filter validations", () => {
    ...
    it("Bug MTA-1762: Name field validations", function () {
        // Navigate to reports
    ...
    it("Bug MTA-1762: Identified risk - Application name field validations", function () {
        // Navigate to reports
        selectUserPerspective(migration);
        clickByText(navMenu, reports);
        cy.wait(2 * SEC);
    ...
    it("Bug MTA-1762: Identified risk - Category field validations", function () {
        // Navigate to reports
        selectUserPerspective(migration);
        clickByText(navMenu, reports);
        cy.wait(2 * SEC);
    ...
    it("Bug MTA-1762: Identified risk - Question field validations", function () {
        // Navigate to reports
        selectUserPerspective(migration);
        clickByText(navMenu, reports);
        cy.wait(2 * SEC);
    ...
    it("Bug MTA-1762: Identified risk - Answer field validations", function () {
        // Navigate to reports
        selectUserPerspective(migration);
        clickByText(navMenu, reports);
        cy.wait(2 * SEC);
