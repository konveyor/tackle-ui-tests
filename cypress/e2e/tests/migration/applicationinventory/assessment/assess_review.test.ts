...
describe(["@tier2"], "Application assessment and review tests", () => {
    ...
    it("tackle2-ui Issue 2418: Validate application assessment and review with low risk and donut chart on review page", function () {
    ...
    it("tackle2-ui Issue: 2418 Application assessment and review with medium risk", function () {
        const application = new Application(getRandomApplicationData());
        application.create();
        cy.wait("@getApplication");
    ...
    it("tackle2-ui Issue 2418: Application assessment and review with high risk", function () {
        const application = new Application(getRandomApplicationData());
        application.create();
        cy.wait("@getApplication");
