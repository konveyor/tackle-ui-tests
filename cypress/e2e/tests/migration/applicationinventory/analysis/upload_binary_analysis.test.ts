...
describe(["@tier1"], "Upload Binary Analysis", () => {
    ...
    it(["@interop"], "Bug 1175 | Upload Binary Analysis", function () {
    ...
    it("Bug 1175 | Custom rules with custom targets", function () {
    ...
    it("Bug 1175 | DIVA report generation", function () {
        const application = new Analysis(
    ...
    it("Bug 1175 | Analysis for jee-example-app upload binary ", function () {
        const application = new Analysis(
            getRandomApplicationData("uploadBinary"),
            getRandomAnalysisData(
    ...
    it("Bug 1175 | Analysis for camunda-bpm-spring-boot-starter", function () {
        const application = new Analysis(
            getRandomApplicationData("uploadBinary"),
    ...
    it("Bug 1175 | Analysis for complete-duke app upload binary ", function () {
        const application = new Analysis(
            getRandomApplicationData("uploadBinary"),
            getRandomAnalysisData(
    ...
    it("Bug 1175 | Analysis for kafka-clients-sb app ", function () {
        const application = new Analysis(
            getRandomApplicationData("uploadBinary"),
