...
import {
    createStakeholderButton,
    stakeholderEmailInput,
    stakeholderNameInput,
    jobFunctionInput,
    groupInput,
    stakeholderFormButton,
    stakeholderTable,
    stakeholderTableRows,
    confirmButton,
} from "../integration/views/stakeholder.view";
import { itemsPerPageSelector } from "../integration/views/common.view";
import {
    createNewStakeholdergroupButton,
    stakeholdergroupNameInput,
    stakeholdergroupDescriptionInput,
    stakeholdergroupCreateButton,
    confirmDeleteButton,
} from "../integration/views/stakeholdergroups.view";
