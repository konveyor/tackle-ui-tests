...
export default defineConfig({
    ...
    env: {
        ...
        jira_stage_datacenter_key: "ODIzNDc2OTk0NDg2OjqhAqjzbsoQ4of8jPGmAPQBgE+X",
        jira_atassian_cloud_email: "mta.qe.testing@gmail.com",
        ...
        jira_atassian_cloud_url: "https://mta-qe-testing.atlassian.net/",
